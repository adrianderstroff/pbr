...
// MakeMultisample creates a multisample texture of the given width and height
// and the number of samples that should be used.
...
func MakeMultisample(width, height, samples int, format uint32, min, mag, s,
	...
	gl.TexImage2DMultisample(gl.TEXTURE_2D_MULTISAMPLE, int32(samples), format,
		int32(width), int32(height), false)
...
// MakeColorMultisample creates a multisample color texture of the given width
// and height and the number of samples that should be used.
...
// MakeDepthMultisample creates a multisample depth texture of the given width
// and height and the number of samples that should be used.
